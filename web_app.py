...
app = Flask(__name__, template_folder=r'E:\IIT Bombay\Python\diabities_prediction\templates')
...
def predict(values, dic):
    ...
    if len(values) == 8:
        ...
        model = pickle.load(open(r"E:\IIT Bombay\Python\diabities_prediction\models",'rb'))
